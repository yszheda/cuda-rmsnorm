...
void rmsnorm_cuda_wrapper(
    ...
    switch (version) {
        ...
        case 37: rmsnorm_v37_persistent_cuda(output, input, weight, bias, eps, use_affine); break;
        case 38: rmsnorm_v38_unroll_small_cuda(output, input, weight, bias, eps, use_affine); break;
        default:
